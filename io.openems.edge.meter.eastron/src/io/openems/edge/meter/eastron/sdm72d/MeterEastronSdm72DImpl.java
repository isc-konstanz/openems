...
// NOTE: we also use the name `Meter.Microcare.SDM72D` for consistency with other SDM meters.
@Designate(ocd = Config.class, factory = true)
@Component(//
		name = "Meter.Microcare.SDM72D", //
		immediate = true, //
...
public class MeterEastronSdm72DImpl extends AbstractOpenemsModbusComponent implements MeterEastronSdm72D,
	...
	protected ModbusProtocol defineModbusProtocol() {
		...
		return new ModbusProtocol(this, //
				...
				new FC4ReadInputRegistersTask(30043 - offset, Priority.HIGH,
						m(ElectricityMeter.ChannelId.VOLTAGE,
								new FloatDoublewordElement(30043 - offset).wordOrder(WordOrder.MSWLSW)
										.byteOrder(ByteOrder.BIG_ENDIAN),
								SCALE_FACTOR_3),
						new DummyRegisterElement(30045 - offset, 30048 - offset),
